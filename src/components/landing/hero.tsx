...
const Hero = () => {
  return (
    <div className="doodle relative flex size-full min-h-screen flex-col items-center justify-between gap-10 overflow-hidden border-b-2 border-ckret-primary px-6 pt-28">
      <div className="flex select-none flex-col gap-4 tracking-widest drop-shadow-xl">
