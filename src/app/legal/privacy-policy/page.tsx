...
const PrivacyPolicy = () => {
  return (
    <div className="[&>p]:my-1">
      ...
      <h3 className="my-3 text-xl font-medium">Interpretation</h3>
      <p>
      ...
      <h3 className="my-3 text-xl font-medium">Definitions</h3>
      ...
      <ul className="list-inside list-disc [&>*]:pl-4">
        ...
        <li>
          <span className="font-medium">Company</span> (referred to as either
          &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
          &quot;Our&quot; in this Agreement) refers to Ckret.
        </li>
        <li>
          <span className="font-medium">Cookies</span> are small files that are
        ...
        <li>
          <span className="font-medium">Country</span> refers to: India
        </li>
        <li>
          <span className="font-medium">Device</span> means any device that can
          access the Service such as a computer, a cellphone or a digital
          tablet.
        </li>
        <li>
          <span className="font-medium">Personal Data</span> is any information
        ...
        <li>
          <span className="font-medium">Third-party Social Media Service</span>{' '}
      ...
      <h3 className="my-3 text-xl font-medium">Types of Data Collected</h3>
      <h4 className="my-2 text-lg font-medium">Personal Data</h4>
      <p>
      ...
      <ul className="list-inside list-disc [&>*]:pl-4">
        <li>
          <span className="font-medium">Cookies or Browser Cookies.</span> A
        ...
        <li>
          <span className="font-medium">Web Beacons.</span> Certain sections of
          our Service and our emails may contain small electronic files known as
      ...
      <h3 className="my-3 text-xl font-medium">Use of Your Personal Data</h3>
      ...
      <ul className="list-inside list-disc [&>*]:pl-4">
        ...
        <li>
          <span className="font-medium">To manage Your Account:</span> to manage
        ...
        <li>
          <span className="font-medium">To contact You:</span> To contact You by
        ...
        <li>
          <span className="font-medium">To provide You</span> with news, special
        ...
        <li>
          <span className="font-medium">To manage Your requests:</span> To
          attend and manage Your requests to Us.
        </li>
        <li>
          <span className="font-medium">For business transfers:</span> We may
        ...
        <li>
          <span className="font-medium">For other purposes</span>: We may use
      ...
      <ul className="list-inside list-disc [&>*]:pl-4">
        <li>
          <span className="font-medium">With Service Providers:</span> We may
        ...
        <li>
          <span className="font-medium">With Affiliates:</span> We may share
        ...
        <li>
          <span className="font-medium">With business partners:</span> We may
          share Your information with Our business partners to offer You certain
          products, services or promotions.
        </li>
        <li>
          <span className="font-medium">With other users:</span> when You share
      ...
      <h3 className="my-3 text-xl font-medium">Delete Your Personal Data</h3>
      <p>
      ...
      <h4 className="my-2 text-lg font-medium">Business Transactions</h4>
      <p>
      ...
      <h4 className="my-2 text-lg font-medium">Law enforcement</h4>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="my-2 text-lg font-medium">Other legal requirements</h4>
      <p>
      ...
      <h2 className="my-4 text-2xl font-medium">Children&apos;s Privacy</h2>
      <p>
      ...
      <h2 className="my-4 text-2xl font-medium">Links to Other Websites</h2>
      <p>
